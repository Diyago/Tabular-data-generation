...
1. Before commit configure prehooks `pre-commit install`
2. Adding tags
...
issues. All complaints will be reviewed and investigated and will result in a response that is deemed necessary and
